...
function launchModal() {
  ...
  vars.select_Prenom.style.border = "1px solid #ccc";
  vars.select_Nom.style.border = "1px solid #ccc";
  vars.select_Mail.style.border = "1px solid #ccc";
  vars.select_Anniv.style.border = "1px solid #ccc";
  vars.select_Num.style.border = "1px solid #ccc";
